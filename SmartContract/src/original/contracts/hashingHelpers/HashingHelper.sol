...
function formatAndHashMessage(bytes32 message) public view returns(bytes32 hashedMessage) {
    assembly {
...
function recoverSigner(bytes32 hashedMessage, uint8 v, bytes32 r, bytes32 s ) public view returns(address recovered){
